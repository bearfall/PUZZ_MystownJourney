...
[Serializable]
public class RPGSkode_DialogueBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        if (!clipPlayed && info.weight > 0f)
        {
            ...
            try
            {
                RPGSkode_GameManager.ins.SetDialogue(dialogueLine);
            }
    ...
    public override void OnBehaviourPause(Playable playable, FrameData info)
    {
        ...
        if (pauseScheduled)
        {
            ...
            RPGSkode_GameManager.ins.PauseTimeline(director);
        }
    }
}